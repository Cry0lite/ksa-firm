...
export function ValuesWeb() {
  ...
  return (
    <div
      className="relative flex h-[600px] w-full items-center justify-center overflow-hidden bg-background p-10"
      ref={containerRef}
    >
      <div className="flex size-full flex-col md:max-w-4xl max-w-2xl max-h-[200px] items-stretch justify-between gap-20">
            ...
            <Popover>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-12 sm:size-16 md:size-20 bg-[#153b55] text-white rounded-full p-2 sm:p-3 md:p-4 shadow-md"
                >
                  <path
              ...
              <PopoverContent>
                <p className="text-[#153b55] font-bold">
            ...
            <Popover>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-12 sm:size-16 md:size-20 bg-[#153b55] text-white rounded-full p-2 shadow-md"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <Popover>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-12 sm:size-16 md:size-20 bg-white rounded-full p-2 sm:p-3 md:p-4 shadow-md border"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <PopoverContent>
                ...
                <p>
                  Access to a collaborative team with deep industry knowledge.
                </p>
              </PopoverContent>
            </Popover>
          </Circle>
            ...
            <Popover>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-12 sm:size-16 md:size-20 bg-white rounded-full p-2 sm:p-3 shadow-md border"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <PopoverContent>
                ...
                <p>
                  We see through our clients’ eyes to deliver meaningful
                  outcomes.
                </p>
              </PopoverContent>
            </Popover>
            ...
            <Popover>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="size-12 sm:size-16 md:size-20 bg-[#153b55] text-white rounded-full p-2 sm:p-3  shadow-md"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <PopoverContent>
                ...
                <p>
                  We listen, we empathize, we understand and we solve - all with
                  a smile.
                </p>
              </PopoverContent>
            </Popover>
